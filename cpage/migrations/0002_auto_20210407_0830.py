...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('summit_app', models.CharField(db_index=True, max_length=128, verbose_name='峰会内部名')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['summit_app', 'cid'], name='cpage_summi_summit__2a98c8_idx'),
        ),
        migrations.AddIndex(
            model_name='summitwebinar',
            index=models.Index(fields=['summit_app', 'wid'], name='cpage_summi_summit__ab8a6d_idx'),
        ),
        ...
        migrations.AddField(
            ...
            name='agenda',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='cpage.summitagenda'),
        ),
    ]
